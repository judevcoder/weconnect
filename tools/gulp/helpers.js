...
module.exports = {
    ...
    demoPath: "resources/js/demo",

    includePaths: [
        "resources/sass/framework",
        "resources/sass/framework/vendors/bootstrap"
    ],
    ...
    objectWalkRecursive: function(array, funcname, userdata) {
        ...
        for (var key in array) {
            ...
            if (
                Object.prototype.toString.call(array[key]) === "[object Object]"
            ) {
                ...
                if (
                    module.exports.objectWalkRecursive.apply(null, funcArgs) ===
                    false
                ) {
                    return false;
                }
            ...
            outputs.forEach(function(output) {
                if (output.indexOf("/**/") !== -1) {
                    module.exports.getDemos().forEach(function(demo) {
                        var outputPath = path
                            .replace(matched[0], output.replace("**", demo))
                            .replace(outputFile, "");
                        var f = filter(outputPath, { restore: true });
                        // exclude unrelated demo assets
                        if (
                            outputPath.indexOf("/assets/demo/") !== -1 &&
                            outputPath.indexOf("/assets/demo/" + demo) === -1
                        ) {
    ...
    bundle: function(bundle) {
        ...
        if (
            typeof bundle.src !== "undefined" &&
            typeof bundle.bundle !== "undefined"
        ) {
            ...
            if ("mandatory" in bundle.src && "optional" in bundle.src) {
                ...
                for (var vendor in vendors) {
                    ...
                    for (var type in vendorObj) {
                        ...
                        switch (type) {
                            case "fonts":
                                gulp.src(vendorObj[type]).pipe(
                                    _self.outputChannel(
                                        bundle.bundle[type] + "/" + vendor
                                    )()
                                );
                                break;
                            case "images":
            ...
            for (var type in bundle.src) {
                ...
                switch (type) {
                    ...
                    case "images":
                        gulp.src(bundle.src[type]).pipe(
                            _self.outputChannel(bundle.bundle[type])()
                        );
                        break;
    ...
    output: function(bundle) {
        ...
        if (
            typeof bundle.src !== "undefined" &&
            typeof bundle.output !== "undefined"
        ) {
            for (var type in bundle.src) {
                if (!bundle.src.hasOwnProperty(type)) continue;
                ...
                switch (type) {
                    ...
                    default:
                        gulp.src(bundle.src[type]).pipe(
                            _self.outputChannel(bundle.output[type])()
                        );
                        break;
                }
            }
    ...
    getDemos: function() {
        return this.getFolders(
            module.exports.rootPath + module.exports.demoPath
        );
    },
